...
StartupEvents.registry("item", event => {
    ...
    tiers.forEach((universal_circuit) => {
        event.create(universal_circuit + "_universal_circuit")
            ...
            .displayName(universal_circuit.toUpperCase() + "通用電路板")
            .tooltip("§7汎用の回路板")
    })
    ...
    event.create("hui_circuit_1")
        .tooltip(Component.literal("§793015-T浮動小数点演算/秒"))
    event.create("hui_circuit_2")
        .tooltip(Component.literal("§776M処理ユニット"))
    event.create("hui_circuit_3")
        .tooltip(Component.literal("§7無効なRSAアルゴリズム"))
    event.create("hui_circuit_4")
        .tooltip(Component.literal("§7第56メルセンヌ素数"))
    event.create("hui_circuit_5")
        .tooltip(Component.literal("§7パラドックス"))
